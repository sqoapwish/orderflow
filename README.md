...
> Текущий статус: завершена инженерная основа проекта. Бизнес-модули добавляются по этапам и не отмечаются готовыми до реализации и тестирования.
...
- JWT access/refresh, сессии и роли `customer`, `manager`, `admin`;
