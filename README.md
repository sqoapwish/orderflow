...
> Текущий статус: завершены инженерная основа, аутентификация, каталог, складской учёт, корзина, транзакционное оформление заказа, Mock Payment lifecycle, Transactional Outbox, неизменяемый аудит и операционные метрики. Следующий инженерный этап — аналитика и минимальный демонстрационный интерфейс. Возможности не отмечаются готовыми до реализации и тестирования.
...
- аналитика и агрегированные отчёты;
